...
class PostSeeder extends Seeder
{
    ...
    {
        return <<<HTML
<h1>Test Long Post: Exploring Laravel Seeder Content</h1>
<p>
    Welcome to this comprehensive test post designed to demonstrate the capabilities of the Laravel seeder. This post includes various HTML elements such as headings, paragraphs, blockquotes, lists, and more to ensure rich content rendering.
</p>

<h2>Introduction</h2>
<p>
    Laravel provides a powerful seeding system that allows developers to populate their databases with sample or test data. This is especially useful for testing, development, and demonstration purposes.
</p>

<blockquote>
    <p>
        "Seeding your database is like planting the seeds for a fruitful development experience."
    </p>
    <footer>— Laravel Enthusiast</footer>
</blockquote>

<h2>Why Use Seeders?</h2>
<p>
    Seeders help automate the process of adding data to your database. They are particularly useful for:
</p>
<ul>
    <li>Testing application features with realistic data</li>
    <li>Demonstrating UI components with sample content</li>
    <li>Ensuring consistent data across development environments</li>
</ul>

<h3>Key Features</h3>
<ol>
    <li>Easy to write and maintain</li>
    <li>Supports relationships between models</li>
    <li>Can be run multiple times</li>
</ol>
...
<h2>Conclusion</h2>
<p>
    This test post demonstrates how you can use various HTML elements within your seeded content. Experiment with different tags and structures to ensure your application handles them gracefully.
</p>
    ...
    public function run(): void
    {
        /*Post::factory()->create([
            ...
            'content' => '<h1>Fadgram Laravel Starter Kit</h1>
              ...
              <h2>Installation</h2>
              <pre><code>
              git clone https://github.com/your-repo/fadgram-laravel-starter-kit.git
            ...
            $post->addMedia(public_path('assets/images/laravel-fadgram.png'))->preservingOriginal()->toMediaCollection($post->thumbnailCollection());
        });
        ...
        Post::factory()->create([
            ...
            $post->addMedia(public_path('assets/images/fadgram-ui.png'))->preservingOriginal()->toMediaCollection($post->thumbnailCollection());
        });

        Post::factory()->create([
            'user_id' => 1,
            'name' => 'Default layout',
            'slug' => Post::generateSlug('Default layout'),
            'type' => 'post',
            'status' => 'publish',
            'content' => '<p style="box-sizing: border-box; color: rgb(51, 51, 51); font-size: var(--readme-font-size); margin-top: 0px; margin-bottom: 16px; line-height: 1.65; letter-spacing: 0.1px; font-family: &quot;Source Sans Pro&quot;, &quot;Lucida Grande&quot;, sans-serif; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial;">Fadgram UI is a Tailwind CSS plugin that provides a set of custom utility classes to enhance your web development experience. This plugin is designed to work seamlessly with Tailwind CSS, allowing you to quickly and easily style your web applications.<span>&nbsp;</span><a target="_blank" rel="noopener noreferrer" href="https://github.com/user-attachments/assets/f5eb0b42-ad31-46de-9062-a8e2bc6100a3" style="box-sizing: border-box; background-color: transparent; color: var(--wombat-red); text-decoration: none; font-size: 1em; font-weight: 600;"><img src="https://github.com/user-attachments/assets/f5eb0b42-ad31-46de-9062-a8e2bc6100a3" alt="FadgramUI" style="box-sizing: border-box; border-style: none; max-width: 100%;"></a></p>',
        ])->each(function (Post $post) {
        ...
        foreach (self::posts() as $item) {
            ...
            $post = Post::create(array_merge([
                ...
                'type' => 'post',
                'status' => 'publish',
                'slug' => Post::generateSlug($item['name']),
            ...
            if ($post) {
                ...
                if ($thumbnail) {
                    $post->addMedia($thumbnail)->preservingOriginal()->toMediaCollection($post->thumbnailCollection());
                }
                ...
                if ($images) {
                    if (is_array($images)) {
                        foreach ($images as $image) {
                            $post->addMedia($image)->preservingOriginal()->toMediaCollection('images');
                        }
                    }

                    if (is_string($images)) {
                        $post->addMedia($images)->preservingOriginal()->toMediaCollection('images');
                    }
                }
            ...
            /* Post::factory()->create(array_merge([
                'user_id' => 1,
                'type' => 'post',
                'status' => 'publish',
                'slug' => Post::generateSlug($item['name']),
                'content' => self::content(),
            ], $data))->each(function (Post $post) use ($item) {
                //thumbnail
                $thumbnail = data_get($item, 'thumbnail');
                if ($thumbnail) {
                    $post->addMedia($thumbnail)->preservingOriginal()->toMediaCollection($post->thumbnailCollection());
