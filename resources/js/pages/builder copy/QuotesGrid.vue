...
import { useAuthorOptions } from '@/composables/useAuthors';
    ...
    <div class="grid grid-cols-1 gap-3">
        ...
        <div class="col">
            <SelectChoices v-model="block.categories" label="Category" :options="categoryOptions" placeholder="Category"
                :multiple="true" key="categories" class="sm" />
        </div>
        <div class="col">
        ...
        <div class="col">
            <SelectChoices v-model="block.authors" label="By author" :options="authorOptions"
                placeholder="Select author" :multiple="true" key="authors" />
        </div>
        <div class="col">
